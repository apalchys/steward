...
3. If you want to use Dictate, also grant Microphone permission:
...
5. Set up your API keys:
   ...
   - Select "Preferences..."
   - Enter your OpenAI API key in the Providers pane
...
6. To use Refine, select text in any application and press `Command+Shift+F`
7. To start Dictate, press `Command+Shift+D`, speak, then press `Command+Shift+D` again or click `OK`
8. To use Capture, press `Command+Shift+R`, drag to select an area, and wait for the Markdown text to land in your clipboard
